...
// Na integracao continua o codigo publicado e o proprio repositorio, entao as
// garantias abaixo ja valem por construcao. Elas existem para a publicacao
// manual, onde a pasta local pode divergir do que esta no GitHub.
if (!process.env.CI) {
