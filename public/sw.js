const CACHE = 'bistro-v7'
const APP_SHELL = ['/', '/manifest.webmanifest', '/app-icon-192.png', '/app-icon-512.png', '/Destaque.jpeg', '/Promocao_Barao_Vermelho.jpeg', '/Abacaxi_ao_mel.jpeg', '/Combo_Cheese_Tudo.jfif']
